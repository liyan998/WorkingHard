package com.superme.trench.jpush;

import com.superme.trench.UnityPlayerActivity;
...
public class MyReceiver extends BroadcastReceiver {
	...
	/**
	 * { "title": "JPush SDK Demo", "message": "sdf", "extras": { "q": "ddd",
	 * "a": "aaa" } }
	 * 
	 * @param title
	 * @param content
	...
	private static String noti2str(String title, String content, String extras) {
		StringBuilder sb = new StringBuilder();
		sb.append("{\"title\":\"" + title + "\",\"message\":\"" + content
				+ "\",\"extras\":" + extras + "}");
		return sb.toString();
	}

	/**
	 * { "message": "hhh", "extras": { "f": "fff", "q": "qqq", "a": "aaa" } }
	 * 
	 * @param content
	 * @param extras
	 * @return
