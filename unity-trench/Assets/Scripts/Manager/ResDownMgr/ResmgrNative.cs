...
public class ResmgrNative
{
    ...
    public void Update()
    {
        ...
        {
            //计算已经下载的字节数
            downloaded += r.www.bytesDownloaded;
            if (r.www.isDone)
            {
        ...
        taskState.downingSize = taskState.downloadsize + downloaded;
    ...
    {
        Load(remotoUrl + "/" + path, tag, onLoad);
